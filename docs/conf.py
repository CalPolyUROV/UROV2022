...
project = 'Cal Poly UROV Documentation'
copyright = f'{datetime.now().year}, Cal Poly UROV'
author = 'Cal Poly'
...
html_theme_options = {
  ...
  'footer_icons': [
    {
      'name': 'GitHub',
      'url': 'https://github.com/CalPolyUROV/',
      'html': '''
...
html_context = {
  'default_description': 'UROV Documentation',
}
