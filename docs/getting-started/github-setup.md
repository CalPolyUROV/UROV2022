...
1. Install the latest version of [Git](https://git-scm.com/downloads) suited for your machine. If the installation was successful, running ``git --version`` on the command line should produce a similar output as below.
   ```{code-block} git
   git version 2.38.1
   ```
2. Read through [Introduction to GitHub](https://www.notion.so/zarkom/Introduction-to-GitHub-202af6f64bbd4299b15f238dcd09d2a7) which will help you create a GitHub account.
   - If you already have a GitHub account, you can skip this step.
   - Sign up for the [GitHub Student Developer Pack](https://education.github.com/pack) to receive free access to many developer tools.
3. Install [GitHub Desktop](https://git-scm.com/downloads). This will simplify the git workflow so that git commands are no longer required.
   - Signing in with your GitHub account will be needed to access your repositories.

## Additional Reading
- [Learn the GitHub web interface](https://guides.github.com/activities/hello-world)
- [Learn Git](https://try.github.io)
- [Long Video about Git/Github with diagrams](https://www.youtube.com/watch?v=DVRQoVRzMIY)